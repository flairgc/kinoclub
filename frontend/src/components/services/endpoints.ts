...
// Auth
export async function register(data: RegisterData): Promise<{ userId: number }> {
...
export async function login(data: LoginData): Promise<{ message: string; userId: number }> {
...
export async function loginByTelegram(data: TelegramLoginData): Promise<{ message: string; userId: number }> {
