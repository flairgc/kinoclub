...
import { Bookmark, Users, Settings, IconProps as FeatherIconProps } from 'react-feather';
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <div className={clsx(["mt-2", { "text-primary": isActive }])}>{label}</div>
      </div>
    </Button>
  );
}
...
export const BottomNav = () => {
  ...
  return (
    <div
      className="border-t bg-white flex flex-1 justify-around items-center p-2 pb-2"
    >
